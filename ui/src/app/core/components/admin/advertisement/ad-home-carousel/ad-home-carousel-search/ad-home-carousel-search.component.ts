...
@Component({
  selector: 'app-ad-home-carousel-search',
  templateUrl: './ad-home-carousel-search.component.html',
  styleUrls: ['./ad-home-carousel-search.component.scss']
})
export class AdHomeCarouselSearchComponent implements OnInit {
  alert!: Alert;
